...
@onready var items_cat = [
	...
	{
		ITEM_CHECKOUT_BRANCH: Lang.translate("item_checkout_branch"),
		ITEM_DELETE_BRANCH: Lang.translate("item_delete_branch")
	},

	{
		ITEM_COMMIT_ALL: Lang.translate("item_commit_all"),
		ITEM_REVERT_ALL: Lang.translate("item_revert_all"),
	},

	{
		ITEM_CREATE_BRANCH: Lang.translate("item_create_branch"),
		ITEM_MERGE_BRANCH: Lang.translate("item_merge_branch"),
		ITEM_REBASE_BRANCH: Lang.translate("item_rebase_branch")
	},

	{
		ITEM_TAG: Lang.translate("item_tag")
	},

	{
		ITEM_GITIGNORE_MANAGER: Lang.translate("item_gititnore_manager"),
		ITEM_SETTINGS: Lang.translate("item_settings")
	},

	{
		ITEM_LAUNCH_TERMINAL: Lang.translate("node_text_launch_terminal_btn")
	}
]
